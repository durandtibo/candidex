...
Provides functions for authenticating with OpenReview, searching and
fetching author profiles, filtering profiles by affiliation or email,
and serializing profiles for storage in Polars DataFrames.
"""
